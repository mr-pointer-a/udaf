...
# spdlog（≥ 1.10）
find_path(_spdlog_cmake_dir NAMES spdlogConfig.cmake PATHS /usr/lib/x86_64-linux-gnu/cmake/spdlog)
if(_spdlog_cmake_dir)
    get_filename_component(_spdlog_cmake_dir_parent ${_spdlog_cmake_dir} DIRECTORY)
    list(APPEND CMAKE_PREFIX_PATH "${_spdlog_cmake_dir_parent}")
endif()
find_package(spdlog 1.10 QUIET)
unset(_spdlog_cmake_dir)
unset(_spdlog_cmake_dir_parent)
