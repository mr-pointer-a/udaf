...
# spdlog（≥ 1.10）
find_package(spdlog 1.10 QUIET PATHS /usr/lib/x86_64-linux-gnu/cmake)
...
if(UDAF_ENABLE_TESTS)
    find_package(GTest 1.14 QUIET PATHS /usr/lib/x86_64-linux-gnu/cmake)
    if(NOT GTest_FOUND)
...
if(UDAF_ENABLE_BENCH)
    find_package(benchmark 1.8 QUIET PATHS /usr/lib/x86_64-linux-gnu/cmake)
